...
<script>
    $(document).ready(function() {
        ...
        function getAllRole() {
            return $.ajax({
                url: `<?php echo site_url('Admin/getAllRole/') ?>`,
                'type': 'POST',
                data: {},
        ...
        function getAllUser() {
            return $.ajax({
                url: `<?php echo site_url('Admin/getAllUser/') ?>`,
                'type': 'POST',
        ...
        function renderUser(data) {
            ...
            Object.values(data).forEach((user) => {
                ...
                var button = `
                                ...
                                `;
                renderData.push([user['id_user'], user['username'], user['nama'], user['nama_role'], user['status'] == 1 ? 'Active' : 'Non Active', button]);
            });
        ...
        function resetUserModal() {
            ...
            // UserModal.status.val(toolbar.status.val() != -1 ? toolbar.status.val() : "");
        }
        ...
        FDataTable.on('click', '.edit', function() {
            ...
            UserModal.id_role.val(currentData['id_role']);
