...
<head>
    ...
    <!-- Charts -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/plugin/apex-charts.css" />

    <!-- Pages -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/pages/dashboard-ecommerce.css" />

    <!-- Horizontal -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>app-assets/css/layouts/horizontal-menu.css" />

    <!-- Custom -->
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>assets/css/style.css" />

    <title>Ecommerce Dashboard - Yoda Admin Html Template</title>
</head>

<body class="horizontal-active app-layout-bg header-full">
