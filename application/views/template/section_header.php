            ...
            <div class="row w-100 align-items-center justify-content-between position-relative">
                ...
                <div class="hp-header-text-info col col-lg-14 col-xl-16 hp-header-start-text d-flex align-items-center hp-horizontal-none">
                    <div class="d-flex overflow-hidden rounded-4 hp-bg-color-black-0 hp-bg-color-dark-100" style="min-width: 45px; width: 45px; height: 45px">
                        <img src="<?= base_url() ?>app-assets/img/memoji/newspaper.svg" alt="Newspaper" height="80%" style="margin-top: auto; margin-left: auto" />
                    </div>
                ...
                <div class="hp-horizontal-logo-menu d-flex align-items-center w-auto">
                    ...
                    <div class="col hp-flex-none w-auto hp-horizontal-block hp-horizontal-menu ps-24">
                        <?php $this->load->view('template/menu_' . strtolower($this->session->userdata('login')['nama_role'])) ?>
                    </div>
                </div>
                        ...
                        <div class="hover-dropdown-fade w-auto px-0 ms-6 position-relative">
                            <div class="hp-cursor-pointer rounded-4 border hp-border-color-dark-80">
                                <div class="rounded-3 overflow-hidden m-4 d-flex">
                                    <div class="avatar-item hp-bg-info-4 d-flex" style="width: 32px; height: 32px;">
                                        <img src="<?= base_url() ?>app-assets/img/memoji/user-avatar-4.png">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="hp-header-profile-menu dropdown-fade position-absolute pt-18" style="top: 100%; width: 260px;">
                                <div class="rounded hp-bg-black-0 hp-bg-dark-100 px-18 py-24">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <a href="<?= base_url('logout') ?>" class="d-flex align-items-center fw-medium hp-p1-body py-8 px-10 hp-transition hp-hover-bg-primary-4 hp-hover-bg-dark-primary hp-hover-bg-dark-80 rounded" target="_self" style="margin-left: -10px; margin-right: -10px;">
                                                <i class="hp-text-color-dark-0 ri-2x ri-logout-box-line"></i> <span>Logout</span>
                                            </a>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="w-auto px-0">
            <div class="hp-header-logo d-flex align-items-center">
                <a href="index.html" class="position-relative">
                    ...
                    <img class="hp-logo hp-sidebar-visible hp-dark-none" src="<?= base_url() ?>app-assets/img/logo/logo-small.svg" alt="logo" />
                    <img class="hp-logo hp-sidebar-visible hp-dark-block" src="<?= base_url() ?>app-assets/img/logo/logo-small-dark.svg" alt="logo" />
                    <img class="hp-logo hp-sidebar-hidden hp-dir-none hp-dark-none" src="<?= base_url() ?>app-assets/img/logo/logo.svg" alt="logo" />
                    <img class="hp-logo hp-sidebar-hidden hp-dir-none hp-dark-block" src="<?= base_url() ?>app-assets/img/logo/logo.png" alt="logo" />
                    <img class="hp-logo hp-sidebar-hidden hp-dir-block hp-dark-none" src="<?= base_url() ?>app-assets/img/logo/logo.png" alt="logo" />
                    <img class="hp-logo hp-sidebar-hidden hp-dir-block hp-dark-block" src="<?= base_url() ?>app-assets/img/logo/logo.png" alt="logo" />
                </a>
                    ...
                    <div class="row align-items-center">
                        <div class="w-auto px-0">
                            <div class="avatar-item bg-primary-4 d-flex align-items-center justify-content-center rounded-circle" style="width: 48px; height: 48px">
                                <img src="<?= base_url() ?>app-assets/img/memoji/user-avatar-8.png" height="100%" class="hp-img-cover" />
                            </div>
                        </div>
